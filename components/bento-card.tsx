...
export default function BentoCard(props: React.HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 animate-breathe rounded-3xl ring ring-accent/20 blur-sm" />
      <div
      ...
      <Card
        {...props}
        className={cn(
          "relative z-10 h-full rounded-lg border-accent/10 bg-transparent p-6 transition duration-500 hover:border-accent/20 md:p-10",
          props.className,
        )}
      />
    </div>
