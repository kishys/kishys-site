...
export async function generateMetadata(props: {
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "website",
      url: `https://kishansuhirthan.com/project/${params.slug}`,
    },
    twitter: {
...
export default async function Page(props: {
  ...
  return (
    <>
      ...
      <Template className="flex min-h-dvh max-w-screen-2xl flex-col items-center pb-24">
          ...
          <div className="mb-6 flex flex-wrap items-baseline gap-4">
            ...
            <span className="flex items-center gap-4">
              <SocialButton
                ...
                href={`https://github.com/kishansuhirthan/${cleanTitle}`}
              />
